...
<main class="tv-mode tv-mode-shell" data-tv-mode>
  <header class="tv-mode__bar tv-mode-header">
  ...
  <section class="tv-mode__grid tv-mode-grid" aria-live="polite">
    <div class="tv-mode__main tv-mode-main">
      <section class="tv-spotlight tv-panel tv-card" data-tv-spotlight>
      ...
      <div class="tv-mode__split">
        <section class="tv-panel tv-card">
    ...
    <aside class="tv-mode__side tv-mode-right-rail">
      <section class="tv-panel tv-card tv-pulse tv-time-panel">
      ...
      <section class="tv-panel tv-card infra-tv-widget" data-infra-tv-widget>
