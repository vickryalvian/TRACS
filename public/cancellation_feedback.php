...
<div class="main-inner">
  ...
  <!-- ── Recap Analytics Section ──────────────────────────────── -->
  <div class="stat-strip">
    <div class="stat-card blue">
      <div class="stat-glow"></div>
      <div class="stat-ic"><i data-lucide="package"></i></div>
      <div class="stat-num"><?= esc($analytics['top_service']['cancelled_service'] ?? 'None') ?></div>
      <div class="stat-label">Most Cancelled Service (Month)</div>
      <div class="stat-meta">Total: <?= $analytics['top_service']['count'] ?? 0 ?> cases</div>
    </div>
    <div class="stat-card amber">
      <div class="stat-glow"></div>
      <div class="stat-ic"><i data-lucide="alert-circle"></i></div>
      <div class="stat-num"><?= esc($analytics['top_reason']['cancellation_reason'] ?? 'None') ?></div>
      <div class="stat-label">Top Cancellation Reason</div>
      <div class="stat-meta">Usage: <?= $analytics['top_reason']['count'] ?? 0 ?> times</div>
    </div>
    <div class="stat-card green">
      <div class="stat-glow"></div>
      <div class="stat-ic"><i data-lucide="banknote"></i></div>
      <div class="stat-num"><?= esc($analytics['top_resolution']['payment_resolution'] ?? 'None') ?></div>
      <div class="stat-label">Most Used Resolution</div>
      <div class="stat-meta">Total: <?= $analytics['top_resolution']['count'] ?? 0 ?> resolutions</div>
    </div>
  </div>
  ...
  <div class="filter-search-row">
    <div class="filter-bar">
      <a href="?" class="filter-tab <?= empty(array_filter($filters)) ? 'active' : '' ?>">All Feedback</a>
    </div>
  </div>

  <!-- ── Filters (Tier 2) ────────────────────────────────────────── -->
  <div class="filter-search-row filter-search-row-mt">
    <form method="get" class="filter-group-wrap" style="display:flex;gap:12px;align-items:center;flex-wrap:wrap">
      ...
      <a href="cancellation_feedback.php" class="btn btn-ghost btn-sm" style="height:30px; border:1px solid var(--bd2); padding:0 10px; font-size:10px; color:var(--tx3)">
  ...
  <!-- ── Search & Actions (Tier 3) ────────────────────────────────── -->
  <div class="filter-search-row filter-search-row-mt">
    <form method="get" class="search-form-wrap" style="flex:1">
