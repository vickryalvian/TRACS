...
$apiMethodMap = [
    ...
    'abuse-report-note.php' => ['POST'],
    'abuse-report-reorder.php' => ['POST'],
    'abuse-report-status.php' => ['POST'],
    'abuse-report-update.php' => ['POST'],
    'bt-create.php' => ['POST'],
    'bt-delete.php' => ['POST'],
    'bt-update.php' => ['POST'],
    ...
    'screenshot-capture.php' => ['GET'],
    'screenshot-history-image.php' => ['GET'],
    'screenshot-history-list.php' => ['GET'],
    'screenshot-regions.php' => ['GET'],
    'server-health.php' => ['GET'],
    'shift-attachment.php' => ['GET'],
    'shift-create.php' => ['POST'],
    'shift-handover-create.php' => ['POST'],
    'shift-handover-update.php' => ['POST'],
    ...
    'checklist-attachment.php' => ['GET'],
    'checklist-history.php' => ['GET'],
    'checklist-list.php' => ['GET'],
...
$apiPermissionMap = [
    ...
    'abuse-report-note.php' => ['abuse_reports.manage'],
    'abuse-report-reorder.php' => ['abuse_reports.manage'],
    'abuse-report-status.php' => ['abuse_reports.manage'],
    'abuse-report-update.php' => ['abuse_reports.manage'],
    ...
    'checklist-sync.php' => ['checklist.view'],
    'case-update.php' => ['cases.manage'],
    'currency.php' => ['dashboard.view'],
    'currency-history.php' => ['dashboard.view'],
    'currency-rate.php' => ['dashboard.view'],
    ...
    'feedback-autosave.php' => ['cancellation_feedback.manage'],
    ...
    'screenshot-capture.php' => ['dashboard.view'],
    'screenshot-history-image.php' => ['dashboard.view'],
    'screenshot-history-list.php' => ['dashboard.view'],
    'screenshot-regions.php' => ['dashboard.view'],
    'shift-create.php' => ['reports.create'],
    'shift-handover-create.php' => ['reports.create'],
    'shift-handover-update.php' => ['reports.update'],
    ...
    'checklist-attachment.php' => ['checklist.manage'],
    'checklist-history.php' => ['checklist.manage'],
    'checklist-list.php' => ['checklist.manage'],
