...
$notes=$body['notes']??'';
$stmt=$conn->prepare("INSERT INTO tracs_domains (user_id,domain,registrar,expires_at,ssl_active,auto_renew,notes) VALUES (?,?,?,?,?,?,?)");
$stmt->bind_param('isssiis',$uid,$domain,$registrar,$expires,$ssl,$auto,$notes);
