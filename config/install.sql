...
-- ══════════════════════════════════════════════════════════════════════════════
-- SECTION 2B — OPERATIONS: ABUSE REPORTS
-- ══════════════════════════════════════════════════════════════════════════════
...
CREATE TABLE IF NOT EXISTS `tracs_abuse_reports` (
  ...
  DEFAULT CHARSET=utf8mb4
  COLLATE=utf8mb4_unicode_ci
  COMMENT='Abuse incident reports and workflow board';
...
CREATE TABLE IF NOT EXISTS `tracs_abuse_report_events` (
  ...
  DEFAULT CHARSET=utf8mb4
  COLLATE=utf8mb4_unicode_ci
  COMMENT='Abuse report timeline and audit events';
...
CREATE TABLE IF NOT EXISTS `tracs_abuse_report_notes` (
  ...
  DEFAULT CHARSET=utf8mb4
  COLLATE=utf8mb4_unicode_ci
  COMMENT='Internal markdown-like notes for abuse reports';
...
CREATE TABLE IF NOT EXISTS `tracs_abuse_report_evidence` (
  ...
  DEFAULT CHARSET=utf8mb4
  COLLATE=utf8mb4_unicode_ci
  COMMENT='Evidence files for abuse investigations';


-- ══════════════════════════════════════════════════════════════════════════════
-- SECTION 2C — OPERATIONS: CLIENT PORTFOLIO
-- ══════════════════════════════════════════════════════════════════════════════
...
CREATE TABLE IF NOT EXISTS `tracs_clients` (
  ...
  DEFAULT CHARSET=utf8mb4
  COLLATE=utf8mb4_unicode_ci
  COMMENT='Operational client portfolio records';
...
CREATE TABLE IF NOT EXISTS `tracs_client_contacts` (
  ...
  DEFAULT CHARSET=utf8mb4
  COLLATE=utf8mb4_unicode_ci
  COMMENT='Client operational contacts';
...
CREATE TABLE IF NOT EXISTS `tracs_client_services` (
  ...
  `plan_spec` TEXT DEFAULT NULL,
  `billing_cycle` ENUM('monthly','quarterly','semiannual','annual','one_time','custom') NOT NULL DEFAULT 'monthly',
  ...
  INDEX `idx_client_services_type_status` (`service_type`, `status`)
) ENGINE=InnoDB
  DEFAULT CHARSET=utf8mb4
  COLLATE=utf8mb4_unicode_ci
  COMMENT='Client services and renewal tracking';
...
CREATE TABLE IF NOT EXISTS `tracs_client_service_addons` (
  ...
  DEFAULT CHARSET=utf8mb4
  COLLATE=utf8mb4_unicode_ci
  COMMENT='Addons attached to individual client services';
...
CREATE TABLE IF NOT EXISTS `tracs_client_service_renewal_history` (
  ...
  DEFAULT CHARSET=utf8mb4
  COLLATE=utf8mb4_unicode_ci
  COMMENT='Client service renewal audit trail';
...
CREATE TABLE IF NOT EXISTS `tracs_client_billing_records` (
  ...
  DEFAULT CHARSET=utf8mb4
  COLLATE=utf8mb4_unicode_ci
  COMMENT='Client billing, invoice, payment, and tax invoice tracking';
...
CREATE TABLE IF NOT EXISTS `tracs_client_followups` (
  ...
  DEFAULT CHARSET=utf8mb4
  COLLATE=utf8mb4_unicode_ci
  COMMENT='Client operational follow-ups linked to reminders';
...
-- ─────────────────────────────────────────────────────────────────────────────
-- Calendar pilot: manual schedules only
-- ─────────────────────────────────────────────────────────────────────────────
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Manual events for the React Calendar pilot';
