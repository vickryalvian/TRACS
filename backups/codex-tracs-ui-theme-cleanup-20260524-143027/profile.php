      ...
      <form method="post" class="panel profile-section-panel">
        ...
        <div class="profile-form-body">
          <div class="form-row">
            ...
            <div class="form-group" id="visualThemeField"><label class="form-label">Visual Theme</label><select class="form-select" name="visual_theme" id="profileVisualTheme"><option value="default" <?=$visualTheme==='default'?'selected':''?>>Default TRACS</option><option value="tracs_v2" <?=$visualTheme==='tracs_v2'?'selected':''?>>TRACS V2</option></select></div>
          </div>
          <div class="form-row">
