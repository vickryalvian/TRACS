...
$_tracs_bootstrap_visual_theme = str_replace(' ', '_', $_tracs_bootstrap_visual_theme);
if ($_tracs_bootstrap_visual_theme === 'tracsv2' || $_tracs_bootstrap_visual_theme === 'intercom_inspired') {
  $_tracs_bootstrap_visual_theme = 'tracs_v2';
}
if ($_tracs_bootstrap_visual_theme !== '' && $_tracs_bootstrap_visual_theme !== 'tracs_v2') {
...
(function(){
  ...
  function normalizeVisualTheme(value) {
    ...
    if (value === 'tracs_v2' || value === 'tracsv2' || value === 'intercom_inspired') return 'tracs_v2';
  ...
  document.documentElement.setAttribute('data-visual-theme', visual === 'tracs_v2' ? 'tracs-v2' : 'default');
