...
<article class="um-user-card <?=($isIntern && $showInternMeta) ? 'um-user-card-intern ' . esc($monitor ? 'intern-' . $monitor : 'intern-active') : ''?>">
  ...
  <div class="um-user-card-badges">
    ...
    <span class="badge b-info"><?=count($user['role_permissions'] ?? [])?> permissions</span>
  </div>
  <?php if($isIntern && $showInternMeta): ?>
  ...
  <div class="um-user-card-actions">
    ...
    <details class="row-action-menu">
      <summary class="btn btn-ghost btn-icon" title="More actions" aria-label="More actions"><i data-lucide="more-vertical" class="icon-sm"></i></summary>
