    ...
    <div class="fb-inline-form">
      ...
      <div class="fb-inline-grid">
        ...
        <div class="dt-inline-group">
          ...
          <select class="form-select fb-inline-input cf-multi-select" id="inService" multiple size="4">
        ...
        <div class="dt-inline-group">
          ...
          <select class="form-select fb-inline-input cf-multi-select" id="inReason" multiple size="4">
            ...
            <td class="mono text-muted">
              ...
              <details class="row-action-menu">
                ...
                <div class="row-action-popover">
                  <button class="btn btn-ghost btn-sm" type="button" onclick="viewFeedback(<?= $f['id'] ?>)">View</button>
                  <button class="btn btn-ghost btn-sm" type="button" onclick="openEditFeedback(window.feedbackRecords[<?= $f['id'] ?>])">Edit</button>
                  <button class="btn btn-danger btn-sm" type="button" onclick="deleteFeedback(<?= $f['id'] ?>)">Delete</button>
                </div>
              </details>
            </td>
          </tr>
