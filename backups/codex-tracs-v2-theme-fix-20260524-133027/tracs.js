...
const TRACS_VISUAL_THEME_CHOICES = new Set(['default', 'intercom_inspired']);
...
function tracsVisualThemeAttribute(value) {
  return tracsNormalizeVisualThemePreference(value) === 'intercom_inspired' ? 'intercom-inspired' : 'default';
}
