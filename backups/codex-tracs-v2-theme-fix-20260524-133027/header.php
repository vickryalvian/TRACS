...
$_theme_css_v = @filemtime(__DIR__.'/../assets/css/themes/tracs-intercom-inspired.css') ?: time();
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<?php endif; ?>
<link rel="stylesheet" href="assets/css/themes/tracs-intercom-inspired.css?v=<?=$_theme_css_v?>">
  ...
  <div class="sidebar-bottom">
    <details class="user-menu-wrap" id="userMenuWrap">
      ...
      <div class="user-menu" role="menu" aria-label="User account menu">
        ...
        <a href="profile.php?section=preferences#visualThemeField" role="menuitem"><i data-lucide="palette" class="icon-sm"></i>Visual Theme</a>
