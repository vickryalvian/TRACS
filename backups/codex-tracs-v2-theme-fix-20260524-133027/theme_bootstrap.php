...
if ($_tracs_bootstrap_visual_theme !== '' && $_tracs_bootstrap_visual_theme !== 'intercom_inspired') {
...
(function(){
  ...
  function normalizeVisualTheme(value) {
    ...
    if (value === 'intercom_inspired') return 'intercom_inspired';
  ...
  document.documentElement.setAttribute('data-visual-theme', visual === 'intercom_inspired' ? 'intercom-inspired' : 'default');
