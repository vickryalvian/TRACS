...
export function ShiftToolbar({ filters, onMove, onToday, onViewChange }) {
  return (
    <header className="tr:rounded-tracs-lg tr:border tr:border-tracs-border tr:bg-tracs-card tr:shadow-tracs-card">
      <div className="tr:flex tr:flex-col tr:gap-tracs-4 tr:p-tracs-4 tr:xl:flex-row tr:xl:items-center tr:xl:justify-between">
        <div>
          <p className="tr:font-mono tr:text-[9px] tr:font-bold tr:uppercase tr:tracking-[.1em] tr:text-tracs-accent">
            React pilot · read only
          </p>
          <h1 className="tr:mt-tracs-1 tr:text-xl tr:font-bold tr:text-tracs-primary">
            Shift Assignment
          </h1>
      ...
      <div className="tr:flex tr:flex-wrap tr:items-center tr:justify-between tr:gap-tracs-2 tr:border-t tr:border-tracs-border tr:bg-tracs-surface-2 tr:px-tracs-4 tr:py-tracs-3">
