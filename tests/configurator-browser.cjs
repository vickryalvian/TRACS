...
(async () => {
  ...
  try {
    ...
    assert.equal(await page.locator('[data-reset-price]').count(), 0);
    await page.locator('[data-edit-price]').first().click();
    await page.locator('[data-price]').fill('1');
    await page.locator('[data-cancel-price]').click();
    assert.match(await page.locator('.sales-price').first().textContent(), /3\.700\.000/);
    await page.locator('[data-edit-price]').first().click();
    await page.locator('[data-price]').fill('3000000');
