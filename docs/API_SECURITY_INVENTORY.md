...
| Future Shift Assignment v1 mutations | Planned template/overtime/warning contracts | POST/PATCH | Exact operation permission plus object/division scope | Required | Critical; no additional public route exists |
